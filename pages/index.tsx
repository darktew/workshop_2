...
export const getServerSideProps: GetServerSideProps = async ({ req, res }) => {
  const user: string | undefined = req.cookies.usertodo
  if (!user) {
    return {
      redirect: {
        destination: "/login",
...
const Home: React.FC<IProps> = (props) => {
  return (
    <section className="h-full antialiased font-sans bg-gray-200">
        ...
        <div className="py-8">
          ...
          <div className="my-2 flex sm:flex-row flex-col">
            ...
            <div className="flex-1">
              <div className="flex justify-end align-middle sm:flex-row flex-col h-full">
                <div className="flex">
